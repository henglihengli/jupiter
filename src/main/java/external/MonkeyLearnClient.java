...
public class MonkeyLearnClient {
	private static final String API_KEY = "bd7ea122253c1985ca3c71282f8c3fda82980141";
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		// Use the API key from my account
